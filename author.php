...
<div class="container mt-5">
      ...
      <div class="col-md-8">
        <div class="card">
          ...
          $auth_id = (isset($_GET['aid']) ? $_GET['aid'] : '');
          ...
          ?>
           ...
           <?php echo $row['title']; ?>
            ...
            <a href="">
            <ul class="link">
              <li class=""><i class="fa-solid fa-tag tag"></i><?php echo $row['category_name']; ?></li>
              <li class="admin">
          ...
          if(mysqli_num_rows($result1) > 0){
            ...
            if($page > 1){
              echo '<li class="page-item"><a class="page-link" href="author.php?aid='.$auth_id.'&page='.($page - 1).'">Prev</a></li>';
            }
